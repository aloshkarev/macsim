...
static struct rate rateset[] = {
	/*
	 * XXX:
	 * For rate = 1, 2, 5.5, 11 Mbps, we will use mqam and fec of the closest
...
__attribute__((unused)) static size_t rate_len_GI_20 = ARRAY_SIZE(rateset_GI_20);
...
__attribute__((unused)) static size_t rate_len_SGI_20 = ARRAY_SIZE(rateset_SGI_20);
...
__attribute__((unused)) static size_t rate_len_GI_40 = ARRAY_SIZE(rateset_GI_40);
...
__attribute__((unused)) static size_t rate_len_SGI_40 = ARRAY_SIZE(rateset_SGI_40);
